...
export class NeHeroSearchElement extends HTMLElement {
  ...
  constructor() {
    ...
    // Brain gradient (green → purple, matches yourdomain.com branding)
    ...
    // Full brain path (both hemispheres) — cloned from yourdomain/favicon.svg
  ...
  private _applyTheme() {
    ...
    // use them (e.g. yourdomain.com, shadcn/ui, Tailwind themes).
